...
from app.routes import resume, linkedin, verification, github_routes, unified_verification_routes, search_routes, job_routes, agent_routes, ai_analysis_routes
...
app.include_router(ai_analysis_routes.router, prefix="/api/v1")
