            ...
            <Card className="w-full max-w-md relative bg-white/95 backdrop-blur-sm shadow-2xl border-0">
                <CardHeader className="space-y-1 text-center pb-6">
                    <div className="mx-auto mb-4">
                        ...
                        <p className="text-xs text-slate-500 mt-1">AI Resume Screening</p>
                    </div>
                    <CardTitle className="text-2xl font-semibold text-slate-800">Create an account</CardTitle>
                            ...
                            {passwordStrength && (
                                <div className="space-y-1">
                                    ...
                                    <p className="text-xs text-slate-500">
                                        Password strength: <span className={passwordStrength.color === 'bg-green-500' ? 'text-green-600' : passwordStrength.color === 'bg-yellow-500' ? 'text-yellow-600' : 'text-red-600'}>{passwordStrength.label}</span>
                                    </p>
                                </div>
                            )}
                        </div>
